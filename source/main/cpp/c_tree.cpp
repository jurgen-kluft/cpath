...
namespace ncore
{
    namespace npath
    {
        ...
        bool tree_t::find(inode_t root, u32 const find, s8 (*cmp)(u32 const find_item, u32 const node_item, void const* user_data), void const* user_data)
        {
            inode_t node = root;
            while (node != 0)
            {
