...
namespace ncore
{
    ...
    bool pathparser_t::has_device() const { return !m_device.is_empty(); }
    bool pathparser_t::has_path() const { return !m_path.is_empty(); }
    bool pathparser_t::has_filename() const { return !m_filename.is_empty(); }
    bool pathparser_t::has_extension() const { return !m_extension.is_empty(); }

    crunes_t pathparser_t::iterate_folder() const { return m_first_folder; }

    void pathparser_t::parse(const crunes_t& fullpath)
    {
    ...
    crunes_t pathparser_t::deviceAndPath() const
    {
    ...
    crunes_t pathparser_t::path() const
    {
        // example: e:\projects\binary_reader\bin\book.pdf, "projects\binary_reader\bin\"
        return m_path;
    }

    bool pathparser_t::next_folder(crunes_t& folder) const
    {
